...
SOURCES = {
    ...
    "TW": ("data/tw_tariff_source", "tw_tariff", "tw",
           "scripts/hts_automation/chapters_tw.json", "en"),
}
...
def main() -> int:
    ...
    p.add_argument("--jurisdiction", choices=("CA", "EU", "DO", "GB", "XI", "CH", "KR", "TW"), required=True)
